...
def service_connection(key, mask):
    ...
    if mask & selectors.EVENT_WRITE:
        ...
        if sendFlag==True:
            for i in range(32):
                message=struct_packet(RW_field,mode,mic_gain,i,en_bm,en_bc,delay_binary_output[i],mic_en,type,reserved)
                #print(message)
                ...
                data.outb = data.outb+ sendBuf
            print("sending", (data.outb).hex(), "to connection", host, port)
...
type=0
reserved=0
#message=struct_packet(RW_field,mode,mic_gain,31,en_bm,en_bc,delay_binary_output[31],mic_en,type,reserved)
#print(message)
#messagehex = BintoINT(message)
#print(messagehex)
#message1 = int(messagehex[2:4],16) # hex at  1 and 2  
